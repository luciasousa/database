...
Public Class Form1
    Dim CN
    Private Sub TestDBConection(ByVal dbServer As String, ByVal dbName As String, ByVal userName As String, ByVal userPass As String)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        TestDBConection(TextBox1.Text, TextBox2.Text, TextBox2.Text, TextBox3.Text)
    End Sub
